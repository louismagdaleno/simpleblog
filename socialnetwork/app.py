...
def main():
    ...
    app.run(ssl_context=('/etc/letsencrypt/live/louismagdaleno.com/fullchain.pem', '/etc/letsencrypt/live/louismagdaleno.com/privkey.pem'))
